...
//            String keyVal= "jw6CGR29ps19rKGhTGBvZQ==";
            secretKey = ENCODING_KEY.getBytes("UTF-8");;
...
//		 String text = new String(secretKey, "UTF-8");
            ...
            // String data = "externalTransactionId=3111124112279
            // &orderId=4167211441117c6
            // &amount=1.00
            // &currency=INR
            // &description=Waapo-Sbibuddy&callbackUrl=http%3A%2F%2waapo%2FTest%2Ftest.jsp
            // &backUrl=http%3A%2F%2F122.182.6.216%2Freceive%2F135%2FAUTH%2Fservlet%2FBankRespReceive";
...
//		byte[] decodedKey = Base64.decodeBase64(encodedKey.getBytes());
        byte[] decodedKey = Base64.getDecoder().decode(ENCODING_KEY.getBytes("UTF-8"));
